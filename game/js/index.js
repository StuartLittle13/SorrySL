...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      this.msgTitle.html("Awesome BABZZZ!, you cracked the question!! I KNOW IT WAS TOOO DIFFICULT");
      // this is messy
      this.msgText.html(" Chal, Now you are going to experience 3rd Dimension Space!! You will love this ! I bet");
      this.showMsg();
